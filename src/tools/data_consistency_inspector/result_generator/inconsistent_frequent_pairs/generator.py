...
# constants
FIG_NAME = 'inconsistent_frequent_pairs_overview.png'
TOP_10_FIG_NAME = 'top_10_inconsistent_frequent_pairs_overview.png'
TITLE = 'Inconsistent Frequent Pairs Overview'
TOP_10_TITLE = 'Inconsistent Frequent Pairs Overview (top 10)'


class InconsistentFrequentPairsOverviewGenerator(BaseOverviewGenerator):
    _needed_snapshots:list[SnapshotType] = [SnapshotType.COLUMN_PAIR_INCONSISTENCY_PATTERN_SNAPSHOT]
    ...
    def _handle_content(self, parsed_content_dict:dict[SnapshotType, Any], basedir_path:str, name_preffix:str=''):
        column_pair_inconsistency_pattern_snapshot_content = parsed_content_dict[SnapshotType.COLUMN_PAIR_INCONSISTENCY_PATTERN_SNAPSHOT]
        try:
            self._generate_heatmap(column_pair_inconsistency_pattern_snapshot_content, basedir_path, name_preffix=name_preffix)
    ...
    #TODO refactor: extract this function, because it is used also by null value inspector
    def _generate_heatmap(self, column_pair_null_pattern_snapshot_content:ColumnPairInconsistencyPatternSnapshotContent, basedir_path:str, name_preffix:str=''):
